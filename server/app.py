...
# from models import User, Menu, Menu_list, Category_list
# @app.route("/@me")
...
# def menu_list():
#   try:
#     menu_list = db_session.query(Menu_list).all()
#     if menu_list:
#       array = [];
...
#     menu_list_query = db_session.query(Menu_list).get(menu_list_id)
...
#   try:
#     menu_type_list = Menu_list(name=list_name)
